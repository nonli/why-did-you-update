...
var lodash_isequal = __webpack_require__(3);
var lodash_isequal_default = /*#__PURE__*/__webpack_require__.n(lodash_isequal);

// EXTERNAL MODULE: ./node_modules/lodash.isfunction/index.js
var lodash_isfunction = __webpack_require__(4);
...
var lodash_keys = __webpack_require__(5);
var lodash_keys_default = /*#__PURE__*/__webpack_require__.n(lodash_keys);

// EXTERNAL MODULE: ./node_modules/lodash.union/index.js
var lodash_union = __webpack_require__(8);
var lodash_union_default = /*#__PURE__*/__webpack_require__.n(lodash_union);

// EXTERNAL MODULE: ./node_modules/lodash.filter/index.js
var lodash_filter = __webpack_require__(9);
var lodash_filter_default = /*#__PURE__*/__webpack_require__.n(lodash_filter);

// EXTERNAL MODULE: ./node_modules/lodash.every/index.js
var lodash_every = __webpack_require__(10);
var lodash_every_default = /*#__PURE__*/__webpack_require__.n(lodash_every);

// EXTERNAL MODULE: ./node_modules/lodash.pick/index.js
var lodash_pick = __webpack_require__(6);
...
var deepDiff_classifyDiff = function classifyDiff(prev, next, name) {
  ...
  if (immutable["Iterable"].isIterable(prev)) {
    prev = prev.toJS();
  }
  if (immutable["Iterable"].isIterable(next)) {
    next = next.toJS();
  }
  ...
  if (lodash_isequal_default()(prev, next)) {
    return {
  ...
  var isChanged = function isChanged(key) {
    var prevValue = immutable["Iterable"].isIterable(prev[key]) ? prev[key].toJS() : prev[key];
    var nextValue = immutable["Iterable"].isIterable(next[key]) ? next[key].toJS() : next[key];
    return prevValue !== nextValue && !lodash_isequal_default()(prevValue, nextValue);
  };
  var isSameFunction = function isSameFunction(key) {
    var prevFn = prev[key];
    var nextFn = next[key];
    return lodash_isfunction_default()(prevFn) && lodash_isfunction_default()(nextFn) && prevFn.name === nextFn.name;
  };

  var keys = lodash_union_default()(lodash_keys_default()(prev), lodash_keys_default()(next));
  var changedKeys = lodash_filter_default()(immutable["Iterable"].isIterable(keys) ? keys.toJS() : keys, isChanged);

  if (changedKeys.length && lodash_every_default()(changedKeys, isSameFunction)) {
    return {
      type: DIFF_TYPES.FUNCTIONS,
      name: name,
      prev: lodash_pick_default()(prev, changedKeys),
      next: lodash_pick_default()(next, changedKeys)
    };
  }
...
var lodash_isstring = __webpack_require__(11);
...
var normalizeOptions_toRegExp = function toRegExp(s) {
  return lodash_isstring_default()(s) ? new RegExp('^' + s + '$') : s;
};
...
// EXTERNAL MODULE: ./node_modules/lodash.some/index.js
var lodash_some = __webpack_require__(7);
...
var shouldInclude_shouldInclude = function shouldInclude(displayName, _ref) {
  ...
  return lodash_some_default()(include, function (r) {
    return r.test(displayName);
  }) && !lodash_some_default()(exclude, function (r) {
    return r.test(displayName);
  });
};
